...
vehicle = connect(connection_string, wait_ready=True, rate=50)
...
def get_vector_meters(aLocation1, aLocation2):
    """
    Returns the ground distance in metres between two LocationGlobal objects.
    ...
    dlat = dlat * 1.113195e5
    dlong = dlong * 1.113195e5
...
pid = PID(Kp=0.5, Ki=0.000, Kd=0, output_limits=(-25, 25))
offset = 10
